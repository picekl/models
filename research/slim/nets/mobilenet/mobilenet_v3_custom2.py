...
@slim.add_arg_scope
def mobilenet_custom(input_tensor,
              num_classes=1001,
...
mobilenet_custom.default_image_size = 300
...
large = wrapped_partial(mobilenet_custom, depth_multiplier=1.4,conv_defs=V3_LARGE)
small = wrapped_partial(mobilenet_custom, conv_defs=V3_SMALL)
edge_tpu = wrapped_partial(mobilenet_custom,
...
large_minimalistic = wrapped_partial(mobilenet_custom, conv_defs=V3_LARGE_MINIMALISTIC)
small_minimalistic = wrapped_partial(mobilenet_custom, conv_defs=V3_SMALL_MINIMALISTIC)
