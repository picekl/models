...
TF_TRAIN_DIR=/mnt/datagrid/personal/picekluk/SnakeRecognition/checkpoints/inception_v4
TF_CHECKPOINT_PATH=/mnt/datagrid/personal/sulcmila/tf_data/models/inception_v4/inception_v4.ckpt
